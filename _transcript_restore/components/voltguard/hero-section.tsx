...
import { SITE_HEADLINE, SITE_SUBHEADLINE } from "@/lib/constants"

export function HeroSection() {
  return (
    <section 
      className="pt-36 pb-12 md:pt-40 md:pb-20 bg-cover bg-top bg-no-repeat relative min-h-screen flex items-center"
      style={{
