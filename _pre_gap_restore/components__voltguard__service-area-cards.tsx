...
const serviceTypes = [
  {
    icon: Home,
    label: "Residential",
    detail: "Panels, outlets, lighting, smart home, EV chargers",
  },
  {
    icon: Building2,
    label: "Commercial",
    detail: "Tenant build-outs, industrial panels, solar tie-ins",
  },
  {
    icon: AlertTriangle,
    label: "Emergency",
    detail: "Outages, sparking, burning smells, storm damage",
  },
]
      ...
      >
        <CarouselContent className="-ml-3">
          <CarouselItem className="pl-3 basis-full">
            <CardShell icon={Shield} title="Who We Serve">
                ...
                {serviceTypes.map((type) => (
                  ...
                  >
                    <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-orange-500/15">
                      <type.icon className="h-4 w-4 text-orange-400" />
                    </div>
                    <div>
