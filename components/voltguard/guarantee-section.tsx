...
import { FadeInUp, ScaleIn } from "@/lib/scroll-animations"
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {guarantees.map((guarantee, index) => (
            <ScaleIn key={guarantee.title} delay={index * 0.12}>
              <Card className="bg-white border-slate-200 shadow-sm text-center h-full">
